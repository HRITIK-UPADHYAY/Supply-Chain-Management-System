...
public class SupplyChain extends Application {
    ...
    private GridPane headerBar(){
        ...
        searchButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                prodcutDetails.getProductsByName(productName);
                //clear Body and put this new pane in the body
                bodyPane.getChildren().clear();
                bodyPane.getChildren().add(prodcutDetails.getProductsByName(productName));
            }
        });
    ...
    private GridPane loginPage(){
        ...
        loginButton.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                //getText() is used to fetching the record from email and password field.
                ...
                try {
                    if(login.customerLogin(email , password))
                    {
                        ...
                        bodyPane.getChildren().clear();
                        bodyPane.getChildren().add(prodcutDetails.getAllProducts());
                    }
                ...
                //setText() is used to display fetching record.
        ...
        //doing enhancement for look attractive.
        gridPane.setVgap(5); //for Vertical gap.
        gridPane.setHgap(5); //for Horizontal gap.
        gridPane.setMinSize(bodyPane.getMinWidth() , bodyPane.getMinHeight()); // set the minimum size
        gridPane.setAlignment(Pos.CENTER); //set the content to the center.
        gridPane.setStyle("-fx-background-color: #C0C0C0"); //style the content to look attractive.

        //create structur for page.
    ...
    private GridPane footerBar(){
        ...
        buyNowButton.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                Product selectedProduct = prodcutDetails.getSelectedProduct();
    ...
    private Pane createContent(){
        ...
        bodyPane.getChildren().addAll(prodcutDetails.getAllProducts());
